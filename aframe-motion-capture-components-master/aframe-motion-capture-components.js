...
/* 3 */
function(t, e) {
    var i = AFRAME.utils.debug("aframe-motion-capture:avatar-recorder:info")
      , r = AFRAME.utils.debug("aframe-motion-capture:avatar-recorder:warn")
      , o = "avatar-recording";
    AFRAME.registerComponent("avatar-recorder", {
        ...
        replayRecording: function() {
            ...
            r && (i("Replaying recording."),
            e.setAttribute("avatar-replayer", {
                loop: t.loop,
                spectatorMode: t.spectatorPlay,
                spectatorPosition: t.spectatorPosition
            }),
            e.components["avatar-replayer"].startReplaying(r))
        },
        stopReplaying: function() {
            var t = this.el.components["avatar-replayer"];
            t && (i("Stopped replaying."),
            t.stopReplaying(),
            this.el.setAttribute("avatar-replayer", "spectatorMode", !1))
        },
        throttledTick: function() {
            var t = this
              , e = this.el.querySelectorAll("[tracked-controls]");
            this.trackedControllerEls = {},
            e.forEach(function(e) {
                return e.id ? (e.setAttribute("motion-capture-recorder", {
                    autoRecord: !1,
                    visibleStroke: !1
                }),
                t.trackedControllerEls[e.id] = e,
                void (t.isRecording && e.components["motion-capture-recorder"].startRecording())) : void r("Found tracked controllers with no id. It will not be recorded")
            })
        },
        play: function() {
            var t = this;
        ...
        onKeyDown: function(t) {
            ...
            if (32 === e || 80 === e || 67 === e)
                ...
                case 80:
                    ...
                    break;
                case 67:
                    i("Recording cleared from localStorage."),
        ...
        toggleReplaying: function() {
            var t = this.el.components["avatar-replayer"];
            t || (this.el.setAttribute("avatar-replayer", ""),
            t = this.el.components["avatar-replayer"]),
            t.isReplaying ? this.stopReplaying() : this.replayRecording()
        },
        ...
        setupCamera: function() {
            function t(t) {
                r.cameraEl && r.cameraEl.removeAttribute("motion-capture-recorder"),
                r.cameraEl = t,
                r.cameraEl.setAttribute("motion-capture-recorder", {
                    autoRecord: !1,
                    visibleStroke: !1
                }),
                i.removeEventListener("camera-set-active", e)
            }
            var e, i = this.el, r = this;
            return i.camera && i.camera.el ? void t(i.camera.el) : (i.addEventListener("camera-set-active", e),
            void (e = function(e) {
                t(e.detail.cameraEl)
            }
            ))
        ...
        startRecording: function() {
            var t, e = this.trackedControllerEls;
            this.isRecording || (t = Object.keys(e),
            i("Starting recording!"),
            this.stopReplaying(),
            this.setupCamera(),
            this.isRecording = !0,
            this.cameraEl.components["motion-capture-recorder"].startRecording(),
            t.forEach(function(t) {
                e[t].components["motion-capture-recorder"].startRecording()
            }))
        },
        stopRecording: function() {
            var t = this.trackedControllerEls
              , e = Object.keys(t);
            this.isRecording && (i("Stopped recording."),
            this.isRecording = !1,
            this.cameraEl.components["motion-capture-recorder"].stopRecording(),
            e.forEach(function(e) {
                t[e].components["motion-capture-recorder"].stopRecording()
            }),
            this.saveRecording(),
            this.data.autoPlay && this.replayRecording())
        },
        getJSONData: function() {
            var t = {}
              , e = this.trackedControllerEls
              , i = Object.keys(e);
            if (!this.isRecording)
                return this.isRecording = !1,
                t.camera = this.cameraEl.components["motion-capture-recorder"].getJSONData(),
                i.forEach(function(i) {
                    t[i] = e[i].components["motion-capture-recorder"].getJSONData()
                }),
                this.recordingData = t,
                t
        },
        saveRecording: function() {
            var t = this.getJSONData();
            this.data.localStorage && (i("Recording saved to localStorage."),
            this.saveToLocalStorage(t)),
            this.data.saveFile && (i("Recording saved to file."),
            this.saveRecordingFile(t))
        },
        saveToLocalStorage: function(t) {
            localStorage.setItem(o, JSON.stringify(t))
        },
        saveRecordingFile: function(t) {
            var e = JSON.stringify(t)
              , i = this.data.binaryFormat ? "application/octet-binary" : "application/json"
              , r = new Blob([e],{
                type: i
            })
              , o = URL.createObjectURL(r)
              , s = "player-recording-" + document.title + "-" + Date.now() + ".json"
